/**
 * Settings Page - SellerGenix
 * User account settings, company info, and billing management
 * Clean Light Theme
 */
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-1">
                <Link
                  href="/dashboard"
                  className="px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg font-bold transition-all"
                >
                  Dashboard
                </Link>
              </nav>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                ...
                className="px-4 py-2 text-sm text-white bg-gray-900 rounded-xl font-medium transition-all"
              >
                Settings
              </Link>
